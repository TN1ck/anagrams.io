  ...
  render() {
    return (
      <div>
        ...
        <Components.InnerContainer>
          ...
          <StyleguideSection description={'Typographie styles that are used throughout the page.'}>
            ...
            <StyleguideComponent description={'Subtitle'}>
              <Components.SubTitle>{'This is a test title with a '}<strong>{'strong'}</strong>{' inside'}</Components.SubTitle>
            </StyleguideComponent>
        ...
        <div>
          <StyleguideComponent description={'Inner container, creates a container'}>
            <Components.InnerContainer>
              <div style={{background: THEME.colors.secondary, width: '100%', height: 50}}>
              </div>
            </Components.InnerContainer>
          </StyleguideComponent>
          <StyleguideComponent description={'Header container, creates a smaller container'}>
          ...
          <StyleguideComponent description={'Header, creates a colored block that centers the content'}>
        ...
        <Components.InnerContainer>
          <StyleguideSection description={'Buttons'}>
            <StyleguideComponent description={'SmallButton'}>
              <Components.SmallButton active>{'Small Active Button'}</Components.SmallButton>
              <Components.SmallButton active={false}>{'Small Inactive Button'}</Components.SmallButton>
            </StyleguideComponent>
          ...
          <StyleguideSection description={'Searchbar'}>
            <StyleguideComponent description={' '}>
              <Components.SearchBar onChange={() => 2} onSubmit={() => 2} value={'wurst'} />
            </StyleguideComponent>
          </StyleguideSection>
