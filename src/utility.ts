...
export function parseSearch(search: string) {
  ...
  const results = splitted.reduce((current: any, next) => {
...
M ${x1}, ${y1}
L ${x1},${intermediateY}
Q ${x1},${intermediateY + arcRadius} ${x1intermediate},${
    intermediateY + arcRadius
  }
